...
class LookupKeysControllerTest < ActionController::TestCase
  ...
  setup do
    ...
    @create = {"1462788609698"=>{"match"=>"hostgroup=db", "value"=>'4', "skip_foreman"=>"0", "_destroy"=>"false"}}
    @delete = {"0"=>{"match"=>@value.match, "value"=>@value.value, "skip_foreman"=>"0", "_destroy"=>"1", "id"=>@value.id } }
  end
