module PuppetHostExtensions
  ...
  included do
    ...
    delegate :individual_puppetclasses, :classes_in_groups, :parent_classes, :classes, :to => :puppet_aspect, :allow_nil => true
  ...
  def available_puppetclasses
    return puppet_aspect.available_puppetclasses if puppet_aspect

    Puppetclass.scoped
  end

  def puppet_aspect=(val)
    puppet_aspect.clear_puppetinfo(true) if val.nil? && puppet_aspect
    super
  end
end
