class Host::Managed < Host::Base
  ...
  class Jail < ::Safemode::Jail
    allow :name, :diskLayout,
    #:puppetmaster, :puppet_ca_server,
    :operatingsystem, :os,
    #:environment,
    :ptable, :hostgroup,
  ...
  def apply_inherited_attributes(attributes, initialized = true)
    ...
    Facets.registered_facets.values.each do |facet_config|
      ...
      facet_attributes = facet_config.model.inherited_attributes(new_hostgroup, facet_attributes)
      attributes["#{facet_config.name}_attributes"] = facet_attributes if facet_attributes
    end
